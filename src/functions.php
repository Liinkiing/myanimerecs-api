...
if (!function_exists('array_sort_by_occurrences')) {
    function array_sort_by_occurrences(array $array, int $min = 0): array {
...
if (!function_exists('ucollection_sort')) {
    function ucollection_sort(Collection $collection, callable $sort) {
...
if (!function_exists('map_numbers')) {
    function map_numbers($value, $fromLow, $fromHigh, $toLow, $toHigh) {
